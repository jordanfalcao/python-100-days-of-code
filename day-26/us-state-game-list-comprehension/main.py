...
while len(guessed_states) < 50:
    ...
    # if user type "Exit", create a .csv file with all missing States - LIST COMPREHENSION
    if answer_state == "Exit":
        missing_states = [state for state in state_list if state not in guessed_states]  # JUST IN 1 LINE
